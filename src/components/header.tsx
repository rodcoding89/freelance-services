        ...
        <header className='header w-full h-[100px] fixed top-0 left-0 bottom-0 right-0 z-10 flex items-center'>
            <div className='mx-auto flex justify-between items-center w-[85%]'>
                ...
                <div className='relative flex justify-start items-center gap-6'>
                    ...
                    <div className={`languages absolute top-[35px] left-[114px] rounded-lg w-[120px] my-2 bg-white overflow-hidden ${isShowLang ? 'opacity-1' : 'opacity-0'} max-485:left-0 max-485:right-[114px]`}>
