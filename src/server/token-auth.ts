...
const REFRESH_TOCKEN = process.env.NEXT_PUBLIC_MODE ? process.env.ZOHO_REFRESH_TOKEN : process.env.ZOHO_REFRESH_TOKEN
const ZOHO_CLIENT_ID = process.env.NEXT_PUBLIC_MODE ? process.env.ZOHO_DRIVE_CLIENT_ID : process.env.ZOHO_DRIVE_CLIENT_ID
const ZOHO_DRIVE_SECRET = process.env.NEXT_PUBLIC_MODE ? process.env.ZOHO_DRIVE_SECRET : process.env.ZOHO_DRIVE_SECRET
